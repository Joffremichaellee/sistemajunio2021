                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form  @submit.prevent="processQueue" method="POST" enctype = "multipart/form-data">
                                            ...
                                            <vue-dropzone class="dz-message borderdropzone " ref="myVueDropzone" id="dropzone" :options="dropzoneOptions"  v-on:vdropzone-sending="sendingEvent" style=" border: 2px dashed #ccc;"> </vue-dropzone> 
